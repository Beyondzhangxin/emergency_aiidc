...
<div class="mainbox">
	<div class="contentbox">
        <p class="content_head_form">
            ...
            <span class="btnbox">
            <a class="btn2 btn_save" href="javascript:void(0)">保存</a>
            <a class="btn2 btn_save" href="javascript:void(0)">保存并关闭</a>
        ...
        <table class="formtable" border="0" cellpadding="0" cellspacing="0" width="95%">
            <tr>
                <td width="20%" class="txtright">
                    <b class="must">*</b>物资装备名称
                </td>
                <td width="30%">
                    <input type="text" class="txtinput materialName" datatype="*" name="materialName">
                </td>
                ...
                <td width="30%">
                    <input type="text" class="txtinput  teamId" name="teamId">
                </td>
            </tr>
            <tr>
                <td width="20%" class="txtright">
